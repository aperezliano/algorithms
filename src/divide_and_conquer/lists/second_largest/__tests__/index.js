...
it.each([[[1, 1, 1]], [[null, null, null]]])('returns null for arrays with the same elements', (array) => {
  expect(secondLargest(array)).toBeNull();
});

it.each([[[1, 2]], [[3, 4]]])('returns the smallest element for an array of 2 elements', (array) => {
